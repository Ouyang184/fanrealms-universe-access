...
const DIGITAL_PRODUCT_COLUMNS =
  'id, creator_id, title, description, short_description, cover_image_url, asset_url, asset_file_path, trailer_url, project_id, godot_version, license, version, screenshots, status, tags, category, price, pricing_model, created_at, updated_at';
