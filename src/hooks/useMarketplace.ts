...
const DIGITAL_PRODUCT_COLUMNS =
  'id, creator_id, title, description, short_description, cover_image_url, banner_image_url, accent_color, trailer_url, project_id, engine, godot_version, license, version, screenshots, status, tags, category, price, sale_price, pricing_model, created_at, updated_at';
