...
export default function FollowingPage() {
  ...
  const enrichedCreators: EnrichedCreatorProfile[] = creators?.map(creator => ({
    ...creator,
    display_name: creator.display_name || creator.users?.username || 'Creator',
    displayName: creator.display_name || creator.users?.username || 'Creator',
    username: creator.users?.username || 'creator',
    fullName: creator.display_name || creator.users?.username || 'Creator',
