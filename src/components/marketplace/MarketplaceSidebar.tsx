  ...
  return (
    <aside className="space-y-5 text-[13px] lg:sticky lg:top-20 lg:self-start">
      ...
      <Section title="Quick links">
        <Link to="/jam/ebfea603-ca6a-4efa-abd5-28d9e6d33a93" className="block px-1 py-1 text-[13px] font-semibold text-primary hover:underline">Asset Pack Jam #1 — $170 in Prizes</Link>
