...
export function CreatePostForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log('[Creator Studio] Creating post with AUTHOR_ID and NSFW:', {
      ...
      console.log('[Creator Studio] Post created successfully with author_id and NSFW flag:', insertedPost[0]?.author_id, insertedPost[0]?.is_nsfw);
